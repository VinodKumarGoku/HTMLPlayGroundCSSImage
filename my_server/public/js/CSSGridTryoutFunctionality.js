const reduced_size_glyphicon = document.getElementById("reduce_size_glyphicon");
...
function initialize_properties_of_image_elements(event) {
  ...
  // Initialising for Main Category for images
  //initialisation_main_category_images(event);

  // Initialise Sub Category Elements Dynamically
  //initialisation_sub_category_images(event);
